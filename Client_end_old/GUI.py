...
class MainWindow(QMainWindow):
    ...
    def get_data(self):
        ...
        while not data_on_queue_for_GUI.empty():
            ...
            if TDM_data != ["empty string"]:
                ...
                #print(TDM_data, self.column_names[1:])
    ...
    def change_byte_code(self, list_of_byte_code, dataframe_idx):
        ...
        if list_of_byte_code[dataframe_idx] == "--":
            ...
            '''
            for elem in list(byte_code_elem):
                try: 
                    byte_code = str(elem).split('x')[1][:2]
                except:
                    byte_code = "00"
    ...
    def summary(self):
        ...
        if dataframe_idx > 0 and dataframe_idx < self.data.shape[0]:
            self.change_explanation(self.list_of_explanations, dataframe_idx)
            self.change_byte_code(self.list_byte_code_text, dataframe_idx)
