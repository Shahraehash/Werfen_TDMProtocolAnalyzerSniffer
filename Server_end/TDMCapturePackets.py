...
def capture_packet():
    while True:
        ...
        if serial_stream == None:
            continue
        list_of_packets = serial_stream.split(b'\xc3\xaa')
        
        #list_of_packets = TDMStreamingSerial.get_serial_data().split(b'\\xc3\\xaa')
        ...
        if global_vars.buffer_string != "":
            ...
            #print("packet", b'\xc3\xaa' + global_vars.buffer_string)
