...
- Once you are in this folder on your PC run "python3 main.py -v [version of your L3 board] -n [number of L4 boards connected]" in your terminal (default settings are -version == p1b and -number_of_L4s = 7). If you need any help with running it run "python3 main.py -h" in terminal
